...
This document defines the public `WorkflowResult` completion, failure, and navigation semantics. Cross-package conventions belong to the [site package standard](site-package-standard.md).
