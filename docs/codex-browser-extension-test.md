...
`/Users/vladimir/Applications/Codex WebMCP.app`
...
Versioned runtime copies allow Codex WebMCP to run alongside the normal Codex app and avoid modifying the installed bundle. After Codex updates, the launcher creates a runtime copy for the new version. Old runtime versions can be moved to Trash once Codex WebMCP is closed.
